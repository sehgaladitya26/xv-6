...
int main() {
  ...
  26:	4901                	li	s2,0
  28:	4981                	li	s3,0
  2a:	a0bd                	j	98 <main+0x98>
          if (n < IO) {
  2c:	4791                	li	a5,4
  2e:	0297d663          	bge	a5,s1,5a <main+0x5a>
  ...
  44:	86050513          	addi	a0,a0,-1952 # 8a0 <malloc+0xf2>
  48:	00000097          	auipc	ra,0x0
  4c:	6a8080e7          	jalr	1704(ra) # 6f0 <printf>
          exit(0);
  50:	4501                	li	a0,0
  52:	00000097          	auipc	ra,0x0
  56:	2fe080e7          	jalr	766(ra) # 350 <exit>
            sleep(200); // IO bound processes
  5a:	0c800513          	li	a0,200
  5e:	00000097          	auipc	ra,0x0
  62:	382080e7          	jalr	898(ra) # 3e0 <sleep>
  66:	bfe1                	j	3e <main+0x3e>
#ifdef PBS
  ...
  for(;n > 0; n--) {
  68:	fa904fe3          	bgtz	s1,26 <main+0x26>
  6c:	4901                	li	s2,0
  6e:	4981                	li	s3,0
  ...
  70:	45a9                	li	a1,10
  72:	02b9c63b          	divw	a2,s3,a1
  76:	02b945bb          	divw	a1,s2,a1
  7a:	00001517          	auipc	a0,0x1
  7e:	83e50513          	addi	a0,a0,-1986 # 8b8 <malloc+0x10a>
  82:	00000097          	auipc	ra,0x0
  86:	66e080e7          	jalr	1646(ra) # 6f0 <printf>
  exit(0);
  8a:	4501                	li	a0,0
  8c:	00000097          	auipc	ra,0x0
  90:	2c4080e7          	jalr	708(ra) # 350 <exit>
  for(;n > 0; n--) {
  94:	34fd                	addiw	s1,s1,-1
  96:	dce9                	beqz	s1,70 <main+0x70>
      if(waitx(0,&wtime,&rtime) >= 0) {
  98:	fc840613          	addi	a2,s0,-56
  9c:	fcc40593          	addi	a1,s0,-52
  a0:	4501                	li	a0,0
  a2:	00000097          	auipc	ra,0x0
  a6:	36e080e7          	jalr	878(ra) # 410 <waitx>
  aa:	fe0545e3          	bltz	a0,94 <main+0x94>
          trtime += rtime;
  ae:	fc842783          	lw	a5,-56(s0)
  b2:	0127893b          	addw	s2,a5,s2
          twtime += wtime;
  b6:	fcc42783          	lw	a5,-52(s0)
  ba:	013789bb          	addw	s3,a5,s3
  be:	bfd9                	j	94 <main+0x94>
