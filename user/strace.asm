...
main(int argc, char *argv[])
{
  ...
  16:	84e58593          	addi	a1,a1,-1970 # 860 <malloc+0xec>
  1a:	4509                	li	a0,2
  1c:	00000097          	auipc	ra,0x0
  20:	66c080e7          	jalr	1644(ra) # 688 <fprintf>
    exit(1);
  24:	4505                	li	a0,1
  26:	00000097          	auipc	ra,0x0
  2a:	310080e7          	jalr	784(ra) # 336 <exit>
  2e:	84aa                	mv	s1,a0
  30:	892e                	mv	s2,a1
  }
  ...
  38:	202080e7          	jalr	514(ra) # 236 <atoi>
  3c:	00000097          	auipc	ra,0x0
  40:	39a080e7          	jalr	922(ra) # 3d6 <trace>
  44:	04054363          	bltz	a0,8a <main+0x8a>
  48:	01090793          	addi	a5,s2,16
  4c:	ee040713          	addi	a4,s0,-288
  50:	ffd4869b          	addiw	a3,s1,-3
  54:	1682                	slli	a3,a3,0x20
  56:	9281                	srli	a3,a3,0x20
  58:	068e                	slli	a3,a3,0x3
  5a:	96be                	add	a3,a3,a5
  5c:	10090593          	addi	a1,s2,256
  ...
  62:	e310                	sd	a2,0(a4)
  while(i < argc && i < MAXARG) {
  64:	00d78663          	beq	a5,a3,70 <main+0x70>
  68:	07a1                	addi	a5,a5,8
  6a:	0721                	addi	a4,a4,8
  6c:	feb79ae3          	bne	a5,a1,60 <main+0x60>
    i++;
  }
  ...
  7c:	2f6080e7          	jalr	758(ra) # 36e <exec>
  exit(0);
  80:	4501                	li	a0,0
  82:	00000097          	auipc	ra,0x0
  86:	2b4080e7          	jalr	692(ra) # 336 <exit>
    fprintf(STDOUT, "Error(trace): integer mask invalid");
  8a:	00000597          	auipc	a1,0x0
  8e:	7f658593          	addi	a1,a1,2038 # 880 <malloc+0x10c>
  92:	4509                	li	a0,2
  94:	00000097          	auipc	ra,0x0
  98:	5f4080e7          	jalr	1524(ra) # 688 <fprintf>
    exit(1);
  9c:	4505                	li	a0,1
  9e:	00000097          	auipc	ra,0x0
  a2:	298080e7          	jalr	664(ra) # 336 <exit>

00000000000000a6 <_main>:
//
...
_main()
{
  ...
  b2:	f52080e7          	jalr	-174(ra) # 0 <main>
  exit(0);
  b6:	4501                	li	a0,0
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 426:	48e50513          	addi	a0,a0,1166 # 8b0 <digits>
 42a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4f2:	3c2b8b93          	addi	s7,s7,962 # 8b0 <digits>
 ...
 632:	27a90913          	addi	s2,s2,634 # 8a8 <malloc+0x134>
        while(*s != 0){
