...
main(int argc, char *argv[])
{
  ...
  16:	85e50513          	addi	a0,a0,-1954 # 870 <malloc+0xec>
  1a:	00000097          	auipc	ra,0x0
  1e:	6b2080e7          	jalr	1714(ra) # 6cc <printf>
    exit(1);
  22:	4505                	li	a0,1
  ...
  36:	1fe080e7          	jalr	510(ra) # 230 <atoi>
  3a:	00000097          	auipc	ra,0x0
  3e:	390080e7          	jalr	912(ra) # 3ca <trace>
  42:	04054463          	bltz	a0,8a <main+0x8a>
  46:	01090793          	addi	a5,s2,16
  4a:	ee040713          	addi	a4,s0,-288
  4e:	ffd4869b          	addiw	a3,s1,-3
  52:	02069613          	slli	a2,a3,0x20
  56:	01d65693          	srli	a3,a2,0x1d
  ...
  7c:	2ea080e7          	jalr	746(ra) # 362 <exec>
  exit(0);
  80:	4501                	li	a0,0
  82:	00000097          	auipc	ra,0x0
  86:	2a8080e7          	jalr	680(ra) # 32a <exit>
    printf("Error(trace): integer mask invalid\n");
  8a:	00001517          	auipc	a0,0x1
  8e:	80e50513          	addi	a0,a0,-2034 # 898 <malloc+0x114>
  92:	00000097          	auipc	ra,0x0
  96:	63a080e7          	jalr	1594(ra) # 6cc <printf>
    exit(1);
  9a:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 43a:	4ea50513          	addi	a0,a0,1258 # 920 <digits>
 43e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4fa:	3d2c8c93          	addi	s9,s9,978 # 8c8 <malloc+0x144>
 ...
 508:	41cb8b93          	addi	s7,s7,1052 # 920 <digits>
 ...
 62e:	29698993          	addi	s3,s3,662 # 8c0 <malloc+0x13c>
        while(*s != 0){
 632:	85ee                	mv	a1,s11
